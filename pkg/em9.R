...
brainMixtureFit<- function(MRImage.list, fit.control= generateMixtureControl()){
  ...
  cat('Now come *three* progress bars...')
  imputed.fit1<- brainMixtureFitArray(beta.array, fit.control)
	imputed.fit2<- brainMixtureFitArray(beta.array, fit.control)
	imputed.fit3<- brainMixtureFitArray(beta.array, fit.control)
